...
// Etusivu: VR-tyylinen kortti-ulkoasu + mobiilioptimointi
app.get("/", (req, res) => {
    ...
    <style>
      ...
      * {
      ...
      @media (max-width: 600px) {
        ...
        .grid {
          grid-template-columns: 1fr; /* yksi kortti per rivi */
          gap: 14px;
        }
        ...
        .time-big {
          font-size: 36px;   /* isompi mobiilissa */
        }
        ...
        .status-pill {
          padding: 6px 12px;
          font-size: 14px;    /* isompi statuskupla */
        }
